...
def test_discovery_init(mock_session, mock_dependencies):
    ...
    assert engine.df_insumos is not None


def test_discovery_load_db(mock_session, mock_dependencies):
    ing = Ingredient(name="Rose", category="Heart", price=100.0,
                     olfactive_family="Floral", traditional_use="Love")
    psycho = Psychophysics(odor_potency="high",
                           russell_valence=0.8, russell_arousal=0.5)
...
def test_create_flanker(mock_session, mock_dependencies):
    ...
    ing2 = Ingredient(name="Oud", category="Base", price=500.0,
                      olfactive_family="Woody", traditional_use="Incense")
    psycho2 = Psychophysics(odor_potency="high",
                            russell_valence=0.5, russell_arousal=0.5)
    ...
    parent = [{"name": "Rose", "weight_factor": 1.0,
               "category": "Heart", "olfactive_family": "Floral"}]
